...
const initialState = {
  ...
  items: [
    ...
    },
    {
      ...
      price: 43,
      details:
        "Yakuza: Like a Dragons Legendary Hero Edition includes ALL of the games DLC. This DLC adds a wide variety of in-game bonus content, including the Job Set, ...",
      brand: "playstation",
    },
    {
      id: 3,
      ...
      price: 40,
      details:
        "Sackboy: A Big Adventure is a 2020 platform game developed by Sumo Digital and published by Sony Interactive Entertainment for the PlayStation 4 and the ...",
      brand: "playstation",
    },
    {
      id: 4,
    ...
    },
    {
      ...
      price: 45,
      details:
        "  From the creators of ABZÛ, The Pathless is the mythic adventure of an archer and an eagle in a vast forest. ... Become the Hunter, a master of archery who travels ...",
      brand: "playstation",
    },
    {
      id: 6,
      ...
      price: 55,
      details:
        "HITMAN 3 is the dramatic conclusion to the World of Assassination trilogy · Get the HITMAN 3 newsletter. · MEDIA.",
      brand: "playstation",
    },
    {
      id: 7,
    ...
    },
    {
      ...
      price: 0,
      details:
        "Astro's Playroom is a 3D platformer in which the player controls the title character Astro Bot using the DualSense controller. Like the previous game, he is ...",
      brand: "playstation",
    },
    {
      id: 9,
    ...
    },
    {
      ...
      price: 40,
      details:
        "Kena, a young Spirit Guide, travels to an abandoned village in search of the sacred mountain shrine. She struggles to uncover the secrets of ...",
      brand: "playstation",
    },
    {
      id: 12,
      ...
      price: 45,
      details:
        "Tsushima Island is all that stands between mainland Japan and a massive Mongol invasion fleet led by the ruthless and cunning general, Khotun Khan. As the ...",
      brand: "playstation",
    },
    {
      id: 13,
      ...
      price: 40,
      details:
        "Metacritic Game Reviews, Returnal for PlayStation 5, Returnal transforms roguelike gameplay into a third-person shooter where players fight ...",
      brand: "playstation",
    },
    {
      id: 14,
      ...
      price: 40,
      details:
        "DEATHLOOP transports you to the mysterious island of Blackreef, where an eternal struggle between two extraordinary assassins will determine the island's future ...",
      brand: "playstation",
    },
    {
      id: 15,
      ...
      price: 50,
      details:
        "Ratchet & Clank: Rift Apart is a 2021 third-person shooter platform game developed by Insomniac Games and published by Sony Interactive Entertainment for ...",
      brand: "playstation",
    },
    {
      id: 16,
      ...
      price: 45,
      details:
        "Red Dead Online is now available for PlayStation 4, Xbox One, PC and Stadia. Developed by the creators of Grand Theft Auto V and Red Dead Redemption, ...",
      brand: "xbox",
    },
    {
      id: 17,
      ...
      price: 45,
      details:
        "Open World. In the open world of Wild Hunt, you chart your own path to adventure. · Professional Monster Hunter · Story. In a war-torn world, with the Wild Hunt ...",
      brand: "xbox",
    },
    {
      id: 18,
      ...
      price: 40,
      details:
        "Dishonored 2 is set 15 years after the Lord Regent has been vanquished and the dreaded Rat Plague has passed into history. An otherworldly ...",
      brand: "xbox",
    },
    {
      id: 19,
      ...
      price: 40,
      details:
        "DOOM®️ Eternal, the award-winning game and “one of the best first-person shooters ever” according to GameRevolution, is coming to Nintendo Switch. Developed by ...",
      brand: "xbox",
    },
    {
      id: 20,
      ...
      price: 40,
      details:
        "With Xbox Game Pass Ultimate, you get everything in the Gears 5 Game of the Year Edition, plus access to over 100 high-quality console and PC games, and all the ...",
      brand: "xbox",
    },
    {
      id: 21,
      ...
      price: 45,
      details:
        "Sekiro: Shadows Die Twice is a 2019 action-adventure game developed by FromSoftware and published by Activision. The game follows a shinobi known as Wolf as ...",
      brand: "xbox",
    },
    {
      id: 22,
      ...
      price: 45,
      details:
        "Upon release, the console versions of Mortal Kombat 11 received generally favorable reviews, which praised the gameplay, story, graphics, and improved netcode, but it received criticism for the presence of microtransactions and over-reliance on grinding. An expansion for the game was released on May 26, 2020,",
      brand: "xbox",
    },
    {
      id: 23,
      ...
      price: 35,
      details:
        " Live the Horizon Life when you play Forza Horizon 4. Experience a shared world with dynamic seasons. Explore beautiful scenery, collect over 450 cars and become ...",
      brand: "xbox",
    },
    {
      id: 24,
      ...
      price: 45,
      details:
        "“If you enjoy third-person brawlers DMC5 is a must, and if you've never tried one before, this is a great place to start. What a treat.” ... “Devil May Cry 5 is a ...",
      brand: "xbox",
    },
    {
      id: 25,
      ...
      price: 40,
      details:
        "Madden NFL 20 is an American football video game based on the National Football League (NFL), developed by EA Tiburon and published by Electronic Arts. The ...",
      brand: "xbox",
    },
    {
      id: 26,
      ...
      price: 35,
      details:
        "Overwatch is a vibrant team-based shooter set on a near-future earth. Every match is an intense 6v6 battle between a cast of unique heroes, each with their ...",
      brand: "xbox",
    },
    {
      id: 27,
      ...
      price: 40,
      details:
        "Assassin's Creed Odyssey is an action role-playing video game developed by Ubisoft Quebec and published by Ubisoft. It is the eleventh major installment in the franchise",
      brand: "xbox",
    },
    {
      id: 28,
    ...
    },
    {
      ...
      price: 40,
      details:
        "Named Game of the Year 2019 by Giant Bomb, Polygon, Eurogamer, and The Guardian, Outer Wilds is a critically-acclaimed and award-winning open world mystery ...",
      brand: "xbox",
    },
    {
      id: 30,
      ...
      price: 35,
      details:
        "Use Your Skills and Reflexes to Survive. Hollow Knight is a challenging 2D action-adventure. You'll explore twisting caverns, battle tainted creatures and ...",
      brand: "xbox",
    },
    {
      id: 31,
      ...
      price: 45,
      details:
        "Metroid Dread is an action-adventure game in which players control bounty hunter Samus Aran as she explores the planet ZDR. It retains the side-scrolling ...",
      brand: "nintendo",
    },
    {
      id: 32,
      ...
      price: 50,
      details:
        "Player 1 controls Mario while Player 2 controls Cappy. This sandbox-style 3D Mario adventure—the first since 1996's beloved Super Mario 64™️ and 2002's Nintendo ...",
      brand: "nintendo",
    },
    {
      id: 33,
      ...
      price: 40,
      details:
        "Escape the tyrannical clutches of a subterranean society and join Eastward's unlikely duo on an exciting adventure to the land above!",
      brand: "nintendo",
    },
    {
      id: 34,
      ...
      price: 45,
      details:
        "Mario Kart 8 Deluxe is a racing game for the Nintendo Switch, and the first Mario game overall for the console. It is a port in the Mario Kart series, ...",
      brand: "nintendo",
    },
    {
      id: 35,
    ...
    },
    {
      ...
      price: 45,
      details:
        "Players control Zagreus, the son of Hades, as he attempts to escape from the Underworld to reach Mount Olympus, at times aided by gifts bestowed on him from the other Olympians. Each run challenges the player through a random series of rooms populated with enemies and rewards.",
      brand: "nintendo",
    },
    {
      id: 38,
      ...
      price: 45,
      details:
        "Luigi's invited to the towering Last Resort hotel, but when Mario and friends go missing, our green-clad hero will have to conquer his fears to save them. Slam, ...",
      brand: "nintendo",
    },
    {
      id: 39,
      ...
      price: 45,
      details:
        "The Legend of Zelda: Skyward Sword is an action-adventure game in which players take on the role of series protagonist Link through a series of monster- ...",
      brand: "nintendo",
    },
    {
      id: 40,
    ...
    },
    {
      ...
      price: 40,
      details:
        "The kingdom has been ravaged by an origami menace! Join Mario and his new partner, Olivia, as they battle evil Folded Soldiers, repair the damaged landscape, and try to free Princess Peach’s castle from the clutches of King Olly in this comedy-filled adventure, only on the Nintendo Switch™️ system.",
    ...
    },
    {
      ...
      price: 35,
      details:
        "DARK SOULS: REMASTERED includes the main game plus the Artorias of the Abyss DLC. This marks the franchise's debut on a Nintendo platform, and for the first time ever can be played on-the-go with Nintendo Switch. Deep and Dark Universe— Delve into an epic dark fantasy universe stricken by the Curse.",
    ...
    },
    {
      ...
      price: 20,
      details:
        "Batman: Arkham City is a 2011 action-adventure game developed by Rocksteady Studios and published by Warner Bros. Interactive Entertainment. ... In the game's main storyline, Batman is incarcerated in Arkham City, a super-prison enclosing the decaying urban slums of fictional Gotham City.",
    ...
    },
    {
      ...
      price: 45,
      details:
        "Darksiders III on Steam. Return to an apocalyptic Earth in Darksiders III, a hack-n-slash Action Adventure where players assume the role of FURY in her quest to hunt down and dispose of the Seven Deadly Sins. The most enigmatic of the Four Horsemen, FURY must bring balance to the forces that now ravage Earth.",
    ...
    },
    {
      ...
      price: 20,
      details:
        "Fall Guys: Ultimate Knockout on Steam. Fall Guys is a massively multiplayer party game with up to 60 players online in a free-for-all struggle through round after round of escalating chaos until one victor remains!",
    ...
    },
    {
      ...
      price: 35,
      details:
        "Far Cry Primal is an action-adventure video game developed by Ubisoft Montreal and published by Ubisoft. ... It is the first Far Cry game set in pre-modern times. It revolves around the story of Takkar, who starts off as an unarmed hunter and rises to become the leader of a tribe.",
    ...
    },
    {
      ...
      price: 40,
      details:
        "Immortals Fenyx Rising™️ brings grand mythological adventure to life. Play as Fenyx, a new, winged demigod, on a quest to save the Greek gods. - Wield the powers of the gods like Achilles' sword and Daidalos' wings to battle powerful enemies and solve ancient puzzles.",
    ...
    },
    {
      ...
      price: 30,
      details:
        "When the King of All Cosmos accidentally destroys all the stars in the sky, he orders you, his pint-sized princely son, to put the twinkle back in the heavens above. Players can also play on multiplayer mode with a friend by using the two Joy-cons on the Switch. ...",
    ...
    },
    {
      ...
      price: 25,
      details:
        "The best-selling LEGO Batman videogame franchise returns in an out-of-this-world, action-packed adventure! In LEGO Batman™️ 3: Beyond Gotham, the Caped Crusader joins forces with the super heroes of the DC Comics universe and blasts off to outer space to stop the evil Brainiac from destroying Earth.",
    ...
    },
    {
      ...
      price: 30,
      details:
        "Mega Man 11 features 3D polygonal characters and hand-drawn environments, departing from the pixel art-based approach from previous games, and is displayed in 2.5D. It was directed by Koji Oda and produced by Kazuhiro Tsuchiya, with character designs by Yuji Ishihara, and music by Marika Suzuki.",
    ...
    },
    {
      ...
      price: 45,
      details:
        "The events of Metal Gear Rising are set in the year 2018, four years after the events of Guns of the Patriots. The Patriots, a powerful shadow organization running the world's war economy, have been destroyed and Private Military Companies (PMC) have splintered into numerous factions.",
    ...
    },
    {
      ...
      price: 45,
      details:
        "NINJA GAIDEN: Master Collection Deluxe Edition includes the three games, digital artbook, and the game soundtrack. With more than 70 pages in the artbook and over 180 tracks in the soundtrack collection, long-time fans and newcomers alike will get a deeper look into the world of NINJA GAIDEN.",

      brand: "pc",
    },
    {
      id: 61,
      img: "https://www.cnet.com/a/img/DxwnHdIOYJdga4HW46NeXwKcRUI=/1200x630/2021/03/08/b3cb8ee9-8eca-4097-a50f-7224e51b2afe/ps5-playstation-5-sony-hoyle-promo-11.jpg",
    ...
    },
    {
      ...
      price: 69,
      details:
        "Experience Varying Force & Tension At Your Fingertips With Adaptive Triggers - Learn More. Chat Online Using The Built-In Microphone Or By Connecting A Headset To The 3.5mm Jack.",
      brand: "store",
    },
    {
      id: 63,
      ...
      price: 40,
      details:
        "Charge up to two DualSense wireless controllers simultaneously. Dock your DualSense wireless controllers quickly and easily with the charging station's click-in design. Controllers charge as quickly as when connected to your PS5 console.",
    ...
    },
    {
      ...
      price: 79,
      details:
        "Enjoy a seamless, wireless experience with a headset fine-tuned for 3D Audio on PS5 consoles. The PULSE 3D wireless headset features a refined design with dual noise-cancelling microphones, built-in rechargeable battery, and an array of easy-access controls. Available when feature is supported by game.",
    ...
    },
    {
      ...
      price: 79,
      details:
        "With Backbone One, next-level gaming has never been more magical and effortless. Just connect the controller to your iPhone, press the Backbone Button to open the app, and instantly start playing games like Minecraft anywhere, in seconds.",
    ...
    {
      id: 68,
      img: "https://www.cnet.com/a/img/WpOELCs1PpXTKAfYuaBWB01Jvk4=/940x0/2019/10/14/37db79f2-b5da-476b-8c95-f3d4ff6dfeb8/nintendo-switch-lite-12.jpg",
    ...
    },
    {
      ...
      price: 35,
      details:
        "Joy‑Con and Nintendo Switch™️ give you total gameplay flexibility. Games come to life through easy-to-use motion controls and HD rumble—advanced vibration features built into each Joy‑Con. Depending on the game, you might use a single Joy‑Con in each hand—or even give the second one to a friend.",
    ...
    },
    {
      ...
      price: 39,
      details:
        "RGB BACKLIT GAMING KEYBOARD: Redragon LED RGB Keyboard: 4 backlight color effects, 5 levels backlight breathing speed, Ergonomic designed keyboard with 104 keys, 25 keys without conflict, 12 multimedia keys, 8 independent control keys for quick management, splash-proof, WIN key can be disabled for gaming.",
    ...
    },
    {
      ...
      price: 25,
      details:
        "A mouse designed for gamers. Gaming mice have adjustable sensitivity, which is configurable as the number of dots per inch (DPI). ... Higher DPI lets the gamer make quick movements, while lower DPI allows for smaller, precise movements. See DPI, gaming PC and gaming keyboard.",
    ...
    },
    {
      ...
      price: 39,
      details:
        "Discord-certified ClearCast noise cancelling microphone for clear, natural-sounding voice communication on all platforms Arctis signature soundscape emphasizes critical sounds to give you an audio advantage. Play all day with athletics-inspired performance fabric Airweave ear cushions.",

      brand: "store",
    },
  ],
  // Quantity
  // Ternery if -- if we got items in the cart , get it from the local storage and set it into the "addedItems"
  addedItems: localStorage.getItem("cartItems")
    ? JSON.parse(localStorage.getItem("cartItems"))
    : [],
  // Total Price
  // Ternery if -- if we got total price in the cart , get it from the local storage and set it into the "addedItems"
...
const cartReducer = (state = initialState, action) => {
  // ACTION ----- ADD TO CART
  // Checkink if the type of action is "ADD TO CART"
  if (action.type === ADD_TO_CART) {
    // runs over the Items Data object and serch where the item id that matchs the action id
    let addedItem = state.items.find((item) => item.id === action.id);
    // here we are looking for an item inside "addedItems" array that matchs the givven id
    let existed_item = state.addedItems.find((item) => action.id === item.id);

    // if we got item inside the "addedItems"
    if (existed_item) {
      // create new prop that calls quantity and set it to 1
      addedItem.quantity = 1;
      return {
        // taking copy of state
        ...state,
      ...
      // if we didnt found an item iside "addedItems"
      addedItem.quantity = 1;
      return {
        // copy of state
        ...state,
        ...
        // update Total -- total items + thire prices
        total: state.total + addedItem.price,
      };
    }
  }
  ...
  if (action.type === REMOVE_ITEM_FROM_CART) {
    // runs over the item To Remove from Data object and serch where the item id that matchs the action id
    let itemToRemove = state.addedItems.find((item) => item.id === action.id);
    // here we are looking for an new item inside "addedItems" array that doesnt matchs the givven id and the action id
  ...
  // ACTION ----- SUBTRACT FROM CART
  if (action.type === SUBTRACT_FROM_CART) {
    // runs over the item To Remove from Data object and serch where the item id that matchs the action id
    let addedItem = state.addedItems.find((item) => item.id === action.id);
    // Checking if we got one item inside the cart
    if (addedItem.quantity === 1) {
      // filter inside "addedItems" and taking the item that his id doesnt matchs the action id
      let new_items = state.addedItems.filter((item) => item.id !== action.id);
      // Taking new total as total from state - price of item from "addedItem"
